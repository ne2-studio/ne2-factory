...
branch, and hand control back to `ne2-factory backlog`'s orchestrator. This skill runs
unattended (via `ne2-factory backlog run`) inside a fresh session with no prior context —
