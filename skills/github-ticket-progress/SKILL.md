...
| State | Labels | Set by |
|---|---|---|
| Queued, not refined | `backlog` | `./scripts/backlog add`, or the reviewer labeling manually |
...
stand alone — the reviewer may read it without the session that produced it.
